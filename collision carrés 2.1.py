...
class Ceiling(Stage):
    ...
    def display(self):
        canvas.create_rectangle(0, 0, winW, self.y, width=0, fill="#D0DCE0")
...
class WallLeft(Stage):
    ...
    def display(self):
        canvas.create_rectangle(0, 0, self.x, winH, width=0, fill="#D0DCE0")
...
class WallRight(Stage):
    ...
    def display(self):
        canvas.create_rectangle(self.x, 0, winW, winH, width=0, fill="#D0DCE0")
